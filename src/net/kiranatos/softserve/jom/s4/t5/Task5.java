package net.kiranatos.softserve.jom.s4.t5;
...
In the class ArrayUtil write static method named "averageValue(...)" that 
takes an object of Array type as input, and returns the average value its 
elements.
...
Examples of usage: 
        ...
        // Print to display: 3.0
        Array<Double> set2 = new Array<>(new Double[]{1.0, 3.0, 5.0});
        double averageValue21 = ArrayUtil.averageValue(set2);
        System.out.println(averageValue2);
*/
class Array<T> {
    private T[] array;

...
/* Java Multithreading level 1, lection 10, task 3 (ЭТОЙ ЗАДАЧИ БОЛЬШЕ НЕТУ НА САЙТЕ https://javarush.ru, вместо неё ThreadsL1L10T3)
...
public class ThreadsL1L10T3Deleted {
    public static class Solution {
        ...
        public static class Utilizator {
            ...
            public void dispose() {                
                util.doNothing(); //Utilization IS successful
            }
        }

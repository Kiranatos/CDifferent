...
import net.kiranatos.javarush.q2сore.lvl7.Core7Lvl17Lesson10Task08_Bankomat;
    ...
    public static void main(String[] args)  {
        ...
        switch (theChoice) {
            case "1": 
                ...
                break;
            case "2":
                net.kiranatos.javarush.q2сore.lvl7.Core7Lvl17Lesson10Task13_Restaurant.main(null);
                break;
            case "3": 
                //sortStart();
                break;
